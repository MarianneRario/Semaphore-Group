...
<html>
  <head> 
      <meta charset="utf-8">
      <title>Search Clients - Admin | Semaphore</title>

      <link rel="stylesheet" href="../css/search_clients.css">
...
<p><h2 align="left">Seach Clients</h2></p>
            <div class="search-box">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="search_text" id="search_text" class="form-control" placeholder="Search by firstname, lastname, email, company, contact number, country or business type">
                    </div> 
                </div>
            </div>
   <div id="result"></div>
